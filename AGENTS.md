...
- `src/shared/game-simulation.ts` — Tick-Simulation, Damage, Respawn
- `src/shared/constants.ts` — Config-Validierung (Mods, Modi, Maps)
- `src/shared/maps.ts` — Map-Definitionen
